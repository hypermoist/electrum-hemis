...
from electrum_hms.plugins.hw_wallet import plugin
from electrum_hms.gui.qt.wizard.wallet import WCScriptAndDerivation, WCHWUnlock, WCHWXPub, WCHWUninitialized
