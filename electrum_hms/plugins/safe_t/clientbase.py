...
from electrum_hms.util import UserCancelled
from electrum_hms.keystore import bip39_normalize_passphrase
from electrum_hms.bip32 import BIP32Node, convert_bip32_strpath_to_intpath
from electrum_hms.logging import Logger
from electrum_hms.plugin import runs_in_hwd_thread
from electrum_hms.plugins.hw_wallet.plugin import HardwareClientBase, HardwareHandlerBase
...
class SafeTClientBase(HardwareClientBase, GuiMixin, Logger):
    ...
    def has_usable_connection_with_device(self):
        try:
            res = self.ping("electrum-HMS pinging device")
            assert res == "electrum-HMS pinging device"
