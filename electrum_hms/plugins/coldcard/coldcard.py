#
# Coldcard Electrum-HMS plugin main code.
#
#
import os
import time
...
from electrum_hms.bip32 import BIP32Node, InvalidMasterKeyVersionBytes
from electrum_hms.i18n import _
from electrum_hms.plugin import Device, hook, runs_in_hwd_thread
from electrum_hms.keystore import Hardware_KeyStore, KeyStoreWithMPK
from electrum_hms.transaction import PartialTransaction
from electrum_hms.wallet import Standard_Wallet, Multisig_Wallet, Abstract_Wallet
from electrum_hms.util import bfh, versiontuple, UserFacingException
from electrum_hms.logging import get_logger

from ..hw_wallet import HW_PluginBase, HardwareClientBase
from ..hw_wallet.plugin import LibraryFoundButUnusable, only_hook_if_libraries_available

if TYPE_CHECKING:
    from electrum_hms.plugin import DeviceInfo
...
class CKCCClient(HardwareClientBase):
    ...
    def ping_check(self):
        ...
        req = b'1234 Electrum-HMS Plugin 4321'      # free up to 59 bytes
        try:
...
class Coldcard_KeyStore(Hardware_KeyStore):
    ...
    def sign_message(self, sequence, message, password, *, script_type=None):
        ...
        try:
            ...
            # already encoded in Hemis fashion, binary.
    ...
    def _encode_txin_type(txin_type):
        # Map from Electrum-HMS code names to our code numbers.
...
class ColdcardPlugin(HW_PluginBase):
    ...
    def export_ms_wallet(wallet: Multisig_Wallet, fp, name):
        ...
        print('# Exported from Electrum-HMS', file=fp)
