...
from electrum_hms.util import bfh, UserCancelled, UserFacingException
...
from electrum_hms.plugin import Device, runs_in_hwd_thread
...
from electrum_hms.plugins.hw_wallet import HW_PluginBase
from electrum_hms.plugins.hw_wallet.plugin import is_any_tx_output_on_change_branch, \
...
class TrezorPlugin(HW_PluginBase):
    ...
    def get_coin_name(self):
        return "Hemis Testnet" if constants.net.TESTNET else "Hemis"
