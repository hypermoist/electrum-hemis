...
from electrum_hms.wallet import Wallet, create_new_wallet
from electrum_hms.wallet_db import WalletDB
from electrum_hms.commands import Commands
from electrum_hms.util import create_and_start_event_loop, log_exceptions


loop, stopping_fut, loop_thread = create_and_start_event_loop()

config = SimpleConfig({"testnet": True})  # to use ~/.electrum-hms/testnet as datadir
