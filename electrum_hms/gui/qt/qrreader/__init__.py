...
from electrum_hms.qrreader import get_qr_reader, QrCodeResult, MissingQrDetectionLib

from electrum_hms.gui.qt.util import MessageBoxMixin, custom_message_box
...
def find_system_cameras() -> Mapping[str, str]:
    ...
    if sys.platform == 'darwin' or sys.platform in ('windows', 'win32'):
        ...
        from electrum_hms import qrscanner
