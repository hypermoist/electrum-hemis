...
from electrum_hms.bip32 import is_bip32_derivation, BIP32Node, normalize_bip32_derivation, xpub_type
from electrum_hms.daemon import Daemon
from electrum_hms.i18n import _
from electrum_hms.keystore import bip44_derivation, bip39_to_seed, purpose48_derivation, ScriptTypeNotSupported
from electrum_hms.plugin import run_hook, HardwarePluginLibraryUnavailable
from electrum_hms.storage import StorageReadWriteError
from electrum_hms.util import WalletFileException, get_new_wallet_name, UserFacingException, InvalidPassword
from electrum_hms.util import is_subpath
from electrum_hms.wallet import wallet_types
from .wizard import QEAbstractWizard, WizardComponent
from electrum_hms.logging import get_logger, Logger
from electrum_hms import WalletStorage, mnemonic, keystore
from electrum_hms.wallet_db import WalletDB
from electrum_hms.wizard import NewWalletWizard

from electrum_hms.gui.qt.bip39_recovery_dialog import Bip39RecoveryDialog
from electrum_hms.gui.qt.password_dialog import PasswordLayout, PW_NEW, MSG_ENTER_PASSWORD, PasswordLayoutForHW
from electrum_hms.gui.qt.seed_dialog import SeedLayout, MSG_PASSPHRASE_WARN_ISSUE4566, KeysLayout
from electrum_hms.gui.qt.util import (PasswordLineEdit, char_width_in_lineedit, WWLabel, InfoButton, font_height,
...
if TYPE_CHECKING:
    ...
    from electrum_hms.plugin import Plugins
    from electrum_hms.daemon import Daemon
    from electrum_hms.gui.qt import QElectrumApplication

WIF_HELP_TEXT = (_('WIF keys are typed in Electrum, based on script type.') + '\n\n' +
                 _('A few examples') + ':\n' +
                 'p2pkh:KxZcY47uGp9a...       \t-> FhnUDbQmu...\n' +
                 'p2wpkh-p2sh:KxZcY47uGp9a... \t-> 3NhNeZQXF...\n' +
                 'p2wpkh:KxZcY47uGp9a...      \t-> hms1q3fjf...')
    ...
    def on_ready(self):
        ...
        if self.wizard_data['wallet_type'] == 'multisig':
            choices = [
                ...
                ('standard', 'legacy multisig (p2sh)', normalize_bip32_derivation("m/44'/0")),
            ]
