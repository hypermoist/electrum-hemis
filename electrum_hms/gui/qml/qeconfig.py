...
from electrum_hms.bitcoin import TOTAL_COIN_SUPPLY_LIMIT_IN_BTC
from electrum_hms.i18n import set_language, languages
from electrum_hms.logging import get_logger
from electrum_hms.util import base_unit_name_to_decimal_point
...
class QEConfig(AuthMixin, QObject):
    ...
    def btcAmountRegex(self):
        ...
        max_digits_before_dp = (
            ...
            + (base_unit_name_to_decimal_point("HMS") - decimal_point))
