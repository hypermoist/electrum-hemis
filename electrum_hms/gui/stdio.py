...
from electrum_hms import WalletStorage, Wallet
from electrum_hms.wallet import Abstract_Wallet
from electrum_hms.wallet_db import WalletDB
from electrum_hms.util import format_satoshis, EventListener, event_listener
from electrum_hms.bitcoin import is_address, COIN
from electrum_hms.transaction import PartialTxOutput
from electrum_hms.network import TxBroadcastError, BestEffortRequestFailed
...
class ElectrumGui(BaseElectrumGui, EventListener):
    ...
    def network_dialog(self):
        print("use 'electrum-hms setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-hms setconfig' to change your settings")
        return True
