...
if [ ! -z "$ELECBUILD_COMMIT" ] ; then
    ...
    FRESH_CLONE="/tmp/electrum_build/sdist/fresh_clone/electrum-hemis"
...
docker run -it \
    ...
    -v "$PROJECT_ROOT_OR_FRESHCLONE_ROOT":/opt/electrum-hemis \
    --rm \
    --workdir /opt/electrum-hemis/contrib/build-linux/sdist \
