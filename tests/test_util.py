...
from electrum_hms.util import (format_satoshis, format_fee_satoshis, is_hash256_str, chunks, is_ip_address,
...
from electrum_hms.bip21 import parse_bip21_URI, InvalidBitcoinURI
...
class TestUtil(ElectrumTestCase):
    ...
    def test_parse_URI_address(self):
        self._do_test_parse_URI('hemis:FZw2mVm2NMhExB81bycsQT1WfjMFhDDGL9',
    ...
    def test_parse_URI_address_label(self):
        self._do_test_parse_URI('hemis:FZw2mVm2NMhExB81bycsQT1WfjMFhDDGL9?label=electrum%20test',
                                {'address': 'FZw2mVm2NMhExB81bycsQT1WfjMFhDDGL9', 'label': 'electrum-hms test'})

    def test_parse_URI_address_message(self):
        self._do_test_parse_URI('hemis:FZw2mVm2NMhExB81bycsQT1WfjMFhDDGL9?message=electrum%20test',
                                {'address': 'FZw2mVm2NMhExB81bycsQT1WfjMFhDDGL9', 'message': 'electrum-hms test', 'memo': 'electrum-hms test'})

    def test_parse_URI_address_amount(self):
        self._do_test_parse_URI('hemis:FZw2mVm2NMhExB81bycsQT1WfjMFhDDGL9?amount=0.0003',
                                {'address': 'FZw2mVm2NMhExB81bycsQT1WfjMFhDDGL9', 'amount': 30000})

    def test_parse_URI_address_request_url(self):
        self._do_test_parse_URI('hemis:FZw2mVm2NMhExB81bycsQT1WfjMFhDDGL9?r=http://domain.tld/page?h%3D2a8628fc2fbe',
                                {'address': 'FZw2mVm2NMhExB81bycsQT1WfjMFhDDGL9', 'r': 'http://domain.tld/page?h=2a8628fc2fbe'})

    def test_parse_URI_ignore_args(self):
        self._do_test_parse_URI('hemis:FZw2mVm2NMhExB81bycsQT1WfjMFhDDGL9?test=test',
                                {'address': 'FZw2mVm2NMhExB81bycsQT1WfjMFhDDGL9', 'test': 'test'})

    def test_parse_URI_multiple_args(self):
        self._do_test_parse_URI('hemis:FZw2mVm2NMhExB81bycsQT1WfjMFhDDGL9?amount=0.00004&label=electrum-test&message=electrum%20test&test=none&r=http://domain.tld/page',
                                {'address': 'FZw2mVm2NMhExB81bycsQT1WfjMFhDDGL9', 'amount': 4000, 'label': 'electrum-hms-test', 'message': u'electrum-hms test', 'memo': u'electrum-hms test', 'r': 'http://domain.tld/page', 'test': 'none'})

    def test_parse_URI_no_address_request_url(self):
        self._do_test_parse_URI('hemis:?r=http://domain.tld/page?h%3D2a8628fc2fbe',
                                {'r': 'http://domain.tld/page?h=2a8628fc2fbe'})

    def test_parse_URI_invalid_address(self):
        self.assertRaises(InvalidBitcoinURI, parse_bip21_URI, 'hemis:invalidaddress')

    def test_parse_URI_invalid(self):
        self.assertRaises(InvalidBitcoinURI, parse_bip21_URI, 'nothemis:FZw2mVm2NMhExB81bycsQT1WfjMFhDDGL9')

    def test_parse_URI_parameter_pollution(self):
        self.assertRaises(InvalidBitcoinURI, parse_bip21_URI, 'hemis:FZw2mVm2NMhExB81bycsQT1WfjMFhDDGL9?amount=0.0003&label=test&amount=30.0')
    ...
    def test_parse_URI_lightning_consistency(self):
        ...
        self._do_test_parse_URI('hemis:?lightning=',
                                {'lightning': ''})
        # bip21 uri that *only* includes a "lightning" key. LN part has fallback address
        self._do_test_parse_URI('hemis:?lightning=',
                                {'lightning': ''})
        # bip21 uri that includes "lightning" key. LN part does not have fallback address
        self._do_test_parse_URI('hemis:thms1qu5ua3szskclyd48wlfdwfd32j65phxy9yf7ytl?amount=0.0007&message=test266&lightning=',
                                {'address': 'thms1qu5ua3szskclyd48wlfdwfd32j65phxy9yf7ytl',
                                 'amount': 70000,
                                 'lightning': '',
                                 'memo': 'test266',
                                 'message': 'test266'})
        ...
        self.assertRaises(InvalidBitcoinURI, parse_bip21_URI, 'hemis:thms1qvu0c9xme0ul3gzx4nzqdgxsu25acuk9wvsj2j2?amount=0.0007&message=test266&lightning=')
        # bip21 uri that includes "lightning" key. top-level amount mismatches LN amount
        self.assertRaises(InvalidBitcoinURI, parse_bip21_URI, 'hemis:thms1qu5ua3szskclyd48wlfdwfd32j65phxy9yf7ytl?amount=0.0008&message=test266&lightning=')
        # bip21 uri that includes "lightning" key with garbage unparseable value
        self.assertRaises(InvalidBitcoinURI, parse_bip21_URI, 'hemis:thms1qu5ua3szskclyd48wlfdwfd32j65phxy9yf7ytl?amount=0.0008&message=test266&lightning=lntb700u1p3kqy26pp5l7rj7w0u5sdsj24umzdlhdasdasdasdasd')
