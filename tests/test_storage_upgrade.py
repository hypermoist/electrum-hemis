...
import electrum_hms
from electrum_hms.wallet_db import WalletDBUpgrader, WalletDB, WalletRequiresUpgrade, WalletRequiresSplit
from electrum_hms.wallet import Wallet
...
##########
    ...
    plugins: 'electrum_hms.plugin.Plugins'
