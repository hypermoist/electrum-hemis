...
from electrum_hemis.util import print_msg, create_and_start_event_loop
from electrum_hemis.synchronizer import SynchronizerBase
...
try:
    ...
    print("usage: watch_address <hemis_address>")
    sys.exit(1)
