...
from electrum_hemis import bip32, constants, ecc
from electrum_hemis import descriptor
from electrum_hemis.bip32 import BIP32Node, convert_bip32_intpath_to_strpath, normalize_bip32_derivation
from electrum_hemis.bitcoin import EncodeBase58Check, int_to_hex, is_b58_address, is_segwit_script_type, var_int
from electrum_hemis.crypto import hash_160
from electrum_hemis.i18n import _
from electrum_hemis.keystore import Hardware_KeyStore
from electrum_hemis.logging import get_logger
from electrum_hemis.plugin import Device, runs_in_hwd_thread
from electrum_hemis.transaction import PartialTransaction, Transaction, PartialTxInput
from electrum_hemis.util import bfh, UserFacingException, versiontuple
from electrum_hemis.wallet import Standard_Wallet
...
if TYPE_CHECKING:
    from electrum_hemis.plugin import DeviceInfo
...
MSG_NEEDS_FW_UPDATE_SEGWIT = _('Firmware version (or "Hemis" app) too old for Segwit support. Please update at') + \
    ' https://www.ledger.com'
