...
from electrum_hemis.util import bfh, UserCancelled, UserFacingException
from electrum_hemis.bip32 import BIP32Node
...
from electrum_hemis.plugins.hw_wallet import HW_PluginBase
from electrum_hemis.plugins.hw_wallet.plugin import is_any_tx_output_on_change_branch, \
...
class TrezorPlugin(HW_PluginBase):
    ...
    def get_coin_name(self):
        return "Testnet" if constants.net.TESTNET else "Hemis"
