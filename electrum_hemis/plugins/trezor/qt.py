...
from electrum_hemis.plugin import hook
from electrum_hemis.keystore import ScriptTypeNotSupported

from electrum_hemis.plugins.hw_wallet.qt import QtHandlerBase, QtPluginBase
from electrum_hemis.plugins.hw_wallet.plugin import only_hook_if_libraries_available, OutdatedHwFirmwareException

from electrum_hemis.gui.qt.util import (WindowModalDialog, WWLabel, Buttons, CancelButton,
                                  OkButton, CloseButton, PasswordLineEdit, getOpenFileName, ChoiceWidget)
from electrum_hemis.gui.qt.wizard.wallet import WCScriptAndDerivation, WCHWUnlock, WCHWXPub, WalletWizardComponent
...
if TYPE_CHECKING:
    from electrum_hemis.gui.qt.wizard.wallet import QENewWalletWizard
...
RECOMMEND_PIN = _(
    ...
    "for your hemis if your device is lost or stolen.")
PASSPHRASE_NOT_PIN = _(
    "If you forget a passphrase you will be unable to access any "
    "hemis in the wallet behind it.  A passphrase is not a PIN. "
...
class SettingsDialog(WindowModalDialog):
    ...
    def __init__(self, window, plugin, keystore, device_id):
        ...
        def wipe_device():
            ...
            if wallet and sum(wallet.get_balance()):
                ...
                msg = _("Are you SURE you want to wipe the device?\n"
                        "Your wallet still has hemis in it!")
                if not self.question(msg, title=title,
        ...
        pin_msg = QLabel(_("PIN protection is strongly recommended.  "
                           ...
                           "stealing your hemis if they obtain physical "
        ...
        clear_pin_warning = QLabel(
            _("If you disable your PIN, anyone with physical access to your "
              "{} device can spend your hemis.").format(plugin.device))
        ...
        wipe_device_warning = QLabel(
            _("Only wipe a device if you have the recovery seed written down "
              "and the device wallet(s) are empty, otherwise the hemis "
