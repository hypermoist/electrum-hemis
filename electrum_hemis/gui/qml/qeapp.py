...
from electrum_hemis import version, constants
from electrum_hemis.i18n import _
from electrum_hemis.logging import Logger, get_logger
from electrum_hemis.bip21 import BITCOIN_BIP21_URI_SCHEME, LIGHTNING_URI_SCHEME
from electrum_hemis.base_crash_reporter import BaseCrashReporter, EarlyExceptionsQueue
from electrum_hemis.network import Network
from electrum_hemis.plugin import run_hook
...
class ElectrumQmlApplication(QGuiApplication):
    ...
    def __init__(self, args, *, config: 'SimpleConfig', daemon: 'Daemon', plugins: 'Plugins'):
        ...
        qmlRegisterType(QEBitcoin, 'org.electrum', 1, 0, 'Hemis')
        ...
        self.context.setContextProperty('UI_UNIT_NAME', {
            "FEERATE_SAT_PER_VBYTE": electrum_hemis.util.UI_UNIT_NAME_FEERATE_SAT_PER_VBYTE,
            "FEERATE_SAT_PER_VB":    electrum_hemis.util.UI_UNIT_NAME_FEERATE_SAT_PER_VB,
            "TXSIZE_VBYTES":         electrum_hemis.util.UI_UNIT_NAME_TXSIZE_VBYTES,
            "MEMPOOL_MB":            electrum_hemis.util.UI_UNIT_NAME_MEMPOOL_MB,
        })
