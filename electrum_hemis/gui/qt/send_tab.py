...
from electrum_hemis.bitcoin import DummyAddress
from electrum_hemis.plugin import run_hook
from electrum_hemis.util import NotEnoughFunds, NoDynamicFeeEstimates, parse_max_spend
from electrum_hemis.invoices import PR_PAID, Invoice, PR_BROADCASTING, PR_BROADCAST
from electrum_hemis.transaction import Transaction, PartialTxInput, PartialTxOutput
from electrum_hemis.network import TxBroadcastError, BestEffortRequestFailed
from electrum_hemis.payment_identifier import (PaymentIdentifierType, PaymentIdentifier, invoice_from_payment_identifier,
...
class SendTab(QWidget, MessageBoxMixin, Logger):
    ...
    def __init__(self, window: 'ElectrumWindow'):
        ...
        msg = (_("Recipient of the funds.")
               ...
               + _("- a Hemis address or BIP21 URI") + "\n"
    ...
    def check_onchain_outputs_and_show_errors(self, outputs: List[PartialTxOutput]) -> bool:
        ...
        for o in outputs:
            if o.scriptpubkey is None:
                self.show_error(_('Hemis Address is None'))
                return True
            if o.value is None:
