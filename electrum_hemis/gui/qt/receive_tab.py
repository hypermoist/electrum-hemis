...
from electrum_hemis.util import InvoiceError
from electrum_hemis.invoices import pr_expiration_values
...
class ReceiveTab(QWidget, MessageBoxMixin, Logger):
    ...
    def expiry_dialog(self):
        msg = ''.join([
            ...
            _('The hemis address never expires and will always be part of this electrum wallet.'), ' ',
            _('You can reuse a hemis address any number of times but it is not good for your privacy.'),
            '\n\n',
    ...
    def update_view_button(self):
        ...
        if i == 0:
            icon, text = read_QIcon("link.png"), _('Hemis URI')
        elif i == 1:
    ...
    def get_tab_data(self):
        i = self.config.GUI_QT_RECEIVE_TABS_INDEX
        if i == 0:
            out = self.URI, self.URI, self.URI_help, _('Hemis URI')
        elif i == 1:
