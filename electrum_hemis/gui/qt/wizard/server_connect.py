...
from electrum_hemis.wizard import ServerConnectWizard
from electrum_hemis.gui.qt.network_dialog import ProxyWidget, ServerWidget
from electrum_hemis.gui.qt.util import icon_path
...
class WCWelcome(WizardComponent):
    def __init__(self, parent, wizard):
        ...
        self.wizard_title = _('Electrum Hemis Wallet')
