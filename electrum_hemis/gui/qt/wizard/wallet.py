...
from electrum_hemis.bip32 import is_bip32_derivation, BIP32Node, normalize_bip32_derivation, xpub_type
from electrum_hemis.daemon import Daemon
from electrum_hemis.i18n import _
from electrum_hemis.keystore import bip44_derivation, bip39_to_seed, purpose48_derivation, ScriptTypeNotSupported
from electrum_hemis.plugin import run_hook, HardwarePluginLibraryUnavailable
from electrum_hemis.storage import StorageReadWriteError
from electrum_hemis.util import WalletFileException, get_new_wallet_name, UserFacingException, InvalidPassword
from electrum_hemis.util import is_subpath
from electrum_hemis.wallet import wallet_types
from .wizard import QEAbstractWizard, WizardComponent
from electrum_hemis.logging import get_logger, Logger
from electrum_hemis import WalletStorage, mnemonic, keystore
from electrum_hemis.wallet_db import WalletDB
from electrum_hemis.wizard import NewWalletWizard

from electrum_hemis.gui.qt.bip39_recovery_dialog import Bip39RecoveryDialog
from electrum_hemis.gui.qt.password_dialog import PasswordLayout, PW_NEW, MSG_ENTER_PASSWORD, PasswordLayoutForHW
from electrum_hemis.gui.qt.seed_dialog import SeedLayout, MSG_PASSPHRASE_WARN_ISSUE4566, KeysLayout
from electrum_hemis.gui.qt.util import (PasswordLineEdit, char_width_in_lineedit, WWLabel, InfoButton, font_height,
...
if TYPE_CHECKING:
    ...
    from electrum_hemis.plugin import Plugins
    from electrum_hemis.daemon import Daemon
    from electrum_hemis.gui.qt import QElectrumApplication
...
class WCWalletType(WalletWizardComponent):
    def __init__(self, parent, wizard):
        ...
        wallet_kinds = [
            ...
            ('imported',  _('Import Hemis addresses or private keys')),
        ]
...
class WCImport(WalletWizardComponent):
    def __init__(self, parent, wizard):
        WalletWizardComponent.__init__(self, parent, wizard, title=_('Import Hemis Addresses or Private Keys'))
        message = _(
            'Enter a list of Hemis addresses (this will create a watching-only wallet), or a list of private keys.')
